...
CREATE TABLE `hall` (
  `NumberRow` int DEFAULT NULL,
  `row_` int DEFAULT NULL,
...
INSERT INTO `hall` VALUES (4,2,10,'Very Comfort','NONE'),(2,2,12,'Comfort','Yes'),(6,1,5,'Not Comfortable','NONE'),(3,2,19,'Very Comfort','NONE'),(1,4,1,'Comfort','Yes');
